                                            ...
                                            <tr data-id="{{ $year->id }}" data-name="{{ $year->academic_year }}"
                                                ...
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        @hasrole('Admin')
                                                            @if ($year->total_post > 0)
                                                            <button type="button" class="btn"
                                                            style="cursor:not-allowed;opacity:0.6;" data-toggle="tooltip" data-placement="top" title="This academic year cannot be edited or deleted because there are already ideas in this academic year.">
