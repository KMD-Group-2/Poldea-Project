            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="d-flex flex-row no-block">
                        ...
                        <div class="align-self-center m-l-20">
                            <h3 class="m-b-0 text-info">{{ $counts[2]->count }}</h3>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="d-flex flex-row no-block">
                        ...
                        <div class="align-self-center m-l-20">
                            <h3 class="m-b-0 text-success">{{ $counts[3]->count }}</h3>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="d-flex flex-row no-block">
                        ...
                        <div class="align-self-center m-l-20">
                            <h3 class="m-b-0 text-primary">{{ $counts[4]->count }}</h3>
                    ...
                    <div class="card-header" style="background-color:rgba(100, 97, 97, 0.03)">
                        <div class="card-title">Recent Idea Posts
                            <div class="card-actions">
                                <a href="{{ route('qa_c.idea_report') }}?date_range=&status=&post_type=all" class="btn waves-effect waves-light btn-sm btn-secondary" style="width:100px;">Show All</a>
                            </div>
                        </div>
                    </div>
